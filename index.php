...
<div id="wrapper">
	<div id="header">
    <a href="index.php"><img src="xres/images/logo.png" class="logo" alt="James Buchanan Pub and Restaurant" /></a>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/15.jpg" width="861" height="379"  alt="" /></li>
                    ...
                    <li><img src="xres/images/jb2/18.jpg" width="861" height="379"  alt="" /></li>
              </ul>
